...
\begin{frame}{Der Anfang}
	\begin{figure}
		...
		% aktualisiere den Speicher mit neuem Vektor aus Multiplikation (Speicher für nächsten Zeitschritt)
		% y ist die Wahrscheinlichkeitsverteilung von Buchstaben unseres Outputs
	\end{figure}
\end{frame}
